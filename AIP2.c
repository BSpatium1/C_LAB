...
int main(){
    ...
    short int min2 = 0;
    printf("unsigned short int: %lld, %lli, %d\n",size_byte2,max2,min2);
    ...
    printf("unsigned char: %lld, %lli, %lli\n",size_byte4,max4,min4);
